Customer support conversational agent based on deep learning

# Dataset 
Dataset used for training chatbot can be found [here](https://www.kaggle.com/thoughtvector/customer-support-on-twitter/data).
